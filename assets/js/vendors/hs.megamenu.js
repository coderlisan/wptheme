...
(function ($) {
			...
			this.$element
				...
				.on(
					...
					function (e) {
						...
						// Lazy initialization
						if (!$this.data('HSMenuItem')) self.initMenuItem($this, self.getType($this));

						self.closeAll($this.add($this.parents(self.itemsSelector)));
						HSMenuItem = $this.data('HSMenuItem');

						if (HSMenuItem.isOpened) HSMenuItem.desktopHide();
	...
	MegaMenu.prototype.initMenuItem = function (element, type) {
		var self = this,
			Item = new MenuItem(
				element,
				element.children(self.options.classMap[type === 'mega-menu' ? 'megaMenu' : 'subMenu']),
	...
	MegaMenu.prototype.initMobileBehavior = function () {
		...
		this.$element
			...
			.on(
				'click.HSMegaMenu',
				self.options.classMap.hasSubMenu + ' > a, ' + self.options.classMap.hasMegaMenu + ' > a',
				function (e) {
					var $this = $(this).parent(),
						MenuItemInstance;
					...
					if (MenuItemInstance.isOpened) MenuItemInstance.mobileHide();
			...
			.not(this.options.classMap.hasSubMenuActive + ',' + this.options.classMap.hasMegaMenuActive)
	...
	$.fn.HSMegaMenu = function () {
		var _ = this,
			...
			ret;
		for (i = 0; i < l; i++) {
			if (typeof opt == 'object' || typeof opt == 'undefined') _[i].MegaMenu = new MegaMenu(_[i], opt);

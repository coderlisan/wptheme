...
<div class="main">
  ...
  <!--call to action end-->
	...
	<!--ecommerce hosting section start-->
            ...
            <div class="row justify-content-center">
                <div class="col-md-9 col-lg-8">
                    <div class="section-heading text-center mb-4">
						...
						<h5>Datacenter Location: USA</h5>
                        <p class="lead">Professional USA hosting at an affordable price with CWP Control panel</p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-8">
                    <div class="popular-price bg-white pricing-new-wrapper mt-4 p-5 shadow-sm border">
                        <div class="pricing-price d-flex justify-content-between align-items-center pb-4">
							...
							<div>
                            <div class="h2 mb-0 text-dark">$21.17<span class="price-cycle h5">/year</span></div>
							<div class="h2 mb-0 text-dark">৳1800<span class="price-cycle h5">/year</span></div>
							</div>
                        </div>
                        ...
                        <div class="pricing-content">
                            <ul class="list-unstyled pricing-feature-list-2 mt-4">
                                <li><i class="far fa-hdd mr-2"></i>
                                    <p><strong>1 GB</strong> SSD Disk Space</p>
                                ...
                                <li><i class="far fa-mail-bulk mr-2"></i>
                                    <p><strong>400 GB</strong> Brandwidth</p>
                                </li>
                                <li><i class="far fa-browser mr-2"></i>
                                    <p><strong>1</strong> Websites Hosted</p>
                                </li>
                                <li><i class="far fa-mail-bulk mr-2"></i>
                                    <p><strong>1-100</strong> Hourly Email Delivery</p>
                                ...
                                <li><i class="far fa-mail-bulk mr-2"></i>
                                    <p><strong>4</strong> Emails Accounts</p>
                                    <span class="text-under-line" data-toggle="tooltip" data-placement="top" title="" data-original-title="Create an unlimited number of mailboxes at no extra cost."><i class="fad fa-info-circle ml-1"></i></span>
                                </li>
								...
								<li><i class="far fa-headset mr-2"></i>
                                    <p><strong>Free </strong>CDN BETA</p>
                                </li>
                            </ul>
                ...
                <div class="col-lg-4 col-md-6 col-sm-8">
                    <div class="popular-price bg-white pricing-new-wrapper mt-4 p-5 shadow-sm border">
                        <div class="pricing-price d-flex justify-content-between align-items-center pb-4">
                            <span class="p-icon"><i class="fad fa-rocket color-secondary"></i></span>
							<div>
							<div class="h2 mb-0 text-dark">$42.35<span class="price-cycle h5">/year</span></div>
                            <div class="h2 mb-0 text-dark">৳3600<span class="price-cycle h5">/year</span></div>
							</div>
                        </div>
                        <div class="pricing-info">
                            <h5>ECM PACK2 <sup>Popular</sup></h5>
                        </div>
                        <div class="pricing-content">
                            <ul class="list-unstyled pricing-feature-list-2 mt-4">
                                <li><i class="far fa-hdd mr-2"></i>
                                    <p><strong>2 GB</strong> SSD Disk Space</p>
                                    <span class="text-under-line" data-toggle="tooltip" data-placement="top" title="" data-original-title="SSD based cloud storage for awesome performance and reliability for your website."><i class="fad fa-info-circle ml-1"></i></span>
                                </li>
                                <li><i class="far fa-mail-bulk mr-2"></i>
                                    <p><strong>600 GB</strong> Brandwidth</p>
                                </li>
                                <li><i class="far fa-browser mr-2"></i>
                                    <p><strong>1</strong> Websites Hosted</p>
                                </li>
                                <li><i class="far fa-mail-bulk mr-2"></i>
                                    <p><strong>100-200</strong> Hourly Email Delivery</p>
                                    <span class="text-under-line" data-toggle="tooltip" data-placement="top" title="" data-original-title="Create an unlimited number of mailboxes at no extra cost."><i class="fad fa-info-circle ml-1"></i></span>
                                </li>
                                <li><i class="far fa-mail-bulk mr-2"></i>
                                    <p><strong>6</strong> Emails Accounts</p>
                                    <span class="text-under-line" data-toggle="tooltip" data-placement="top" title="" data-original-title="Create an unlimited number of mailboxes at no extra cost."><i class="fad fa-info-circle ml-1"></i></span>
                                </li>
                                <li><i class="far fa-globe mr-2"></i>
                                    <p><strong>Domain </strong>Name</p>
								...
								<li><i class="far fa-headset mr-2"></i><p><strong>Free </strong>CDN BETA</p></li>
                            </ul>
                ...
                <div class="col-lg-4 col-md-6 col-sm-8">
                    <div class="popular-price bg-white pricing-new-wrapper mt-4 p-5 shadow-sm border">
                        <div class="pricing-price d-flex justify-content-between align-items-center pb-4">
                            <span class="p-icon"><i class="fad fa-rocket color-secondary"></i></span>
							<div>
							<div class="h2 mb-0 text-dark">$58.81<span class="price-cycle h5">/year</span></div>
                            <div class="h2 mb-0 text-dark">৳4999<span class="price-cycle h5">/year</span></div>
							</div>
                        </div>
                        <div class="pricing-info">
                            <h5>ECM PACK3</h5>
                        ...
                        <div class="pricing-content">
                            <ul class="list-unstyled pricing-feature-list-2 mt-4">
                                <li><i class="far fa-hdd mr-2"></i>
                                    <p><strong>3 GB</strong> SSD Disk Space</p>
                                    <span class="text-under-line" data-toggle="tooltip" data-placement="top" title="" data-original-title="SSD based cloud storage for awesome performance and reliability for your website."><i class="fad fa-info-circle ml-1"></i></span>
                                </li>
                                <li><i class="far fa-mail-bulk mr-2"></i>
                                    <p><strong>700 GB</strong> Brandwidth</p>
                                </li>
                                <li><i class="far fa-browser mr-2"></i>
                                    <p><strong>1</strong> Websites Hosted</p>
                                </li>
                                <li><i class="far fa-mail-bulk mr-2"></i>
                                    <p><strong>200-300</strong> Hourly Email Delivery</p>
                                    <span class="text-under-line" data-toggle="tooltip" data-placement="top" title="" data-original-title="Create an unlimited number of mailboxes at no extra cost."><i class="fad fa-info-circle ml-1"></i></span>
                                </li>
                                <li><i class="far fa-mail-bulk mr-2"></i>
                                    <p><strong>7</strong> Emails Accounts</p>
                                    <span class="text-under-line" data-toggle="tooltip" data-placement="top" title="" data-original-title="Create an unlimited number of mailboxes at no extra cost."><i class="fad fa-info-circle ml-1"></i></span>
                                </li>
                                <li><i class="far fa-globe mr-2"></i>
                ...
                <div class="col-lg-4 col-md-6 col-sm-8">
                    <div class="popular-price bg-white pricing-new-wrapper mt-4 p-5 shadow-sm border">
                        <div class="pricing-price d-flex justify-content-between align-items-center pb-4">
                            <span class="p-icon"><i class="fad fa-rocket color-secondary"></i></span>
							<div>
                            <div class="h2 mb-0 text-dark">$82.35<span class="price-cycle h5">/year</span></div>
							<div class="h2 mb-0 text-dark">৳7000<span class="price-cycle h5">/year</span></div>
							</div>
                        </div>
                        <div class="pricing-info">
                            <h5>ECM PACK4</h5>
                        ...
                        <div class="pricing-content">
                            <ul class="list-unstyled pricing-feature-list-2 mt-4">
                                <li><i class="far fa-hdd mr-2"></i>
                                    <p><strong>5 GB</strong> SSD Disk Space</p>
                                    <span class="text-under-line" data-toggle="tooltip" data-placement="top" title="" data-original-title="SSD based cloud storage for awesome performance and reliability for your website."><i class="fad fa-info-circle ml-1"></i></span>
                                </li>
                                <li><i class="far fa-mail-bulk mr-2"></i>
                                    <p><strong>1 TB</strong> Brandwidth</p>
                                </li>
                                <li><i class="far fa-browser mr-2"></i>
                                    <p><strong>1</strong> Websites Hosted</p>
                                </li>
								<li><i class="far fa-mail-bulk mr-2"></i>
                                    <p><strong>400-500</strong> Hourly Email Delivery</p>
                                    <span class="text-under-line" data-toggle="tooltip" data-placement="top" title="" data-original-title="Create an unlimited number of mailboxes at no extra cost."><i class="fad fa-info-circle ml-1"></i></span>
                                </li>
                                <li><i class="far fa-mail-bulk mr-2"></i>
                                    <p><strong>10</strong> Emails Accounts</p>
                                    <span class="text-under-line" data-toggle="tooltip" data-placement="top" title="" data-original-title="Create an unlimited number of mailboxes at no extra cost."><i class="fad fa-info-circle ml-1"></i></span>
                                </li>
                                <li><i class="far fa-globe mr-2"></i>
                                    <p><strong>Domain </strong>Name</p>
                ...
                <div class="col-lg-4 col-md-6 col-sm-8">
                    <div class="popular-price bg-white pricing-new-wrapper mt-4 p-5 shadow-sm border">
                        <div class="pricing-price d-flex justify-content-between align-items-center pb-4">
                            <span class="p-icon"><i class="fad fa-rocket color-secondary"></i></span>
							<div>
							<div class="h2 mb-0 text-dark">$13.72<span class="price-cycle h5">/month</span></div>
                            <div class="h2 mb-0 text-dark">৳1166<span class="price-cycle h5">/month</span></div>
							</div>
                        </div>
                        <div class="pricing-info">
                            <h5>ECM PACK5</h5>
                        ...
                        <div class="pricing-content">
                            <ul class="list-unstyled pricing-feature-list-2 mt-4">
                                <li><i class="far fa-hdd mr-2"></i>
                                    <p><strong>10 GB</strong> SSD Disk Space</p>
                                    <span class="text-under-line" data-toggle="tooltip" data-placement="top" title="" data-original-title="SSD based cloud storage for awesome performance and reliability for your website."><i class="fad fa-info-circle ml-1"></i></span>
                                </li>
                                <li><i class="far fa-mail-bulk mr-2"></i>
                                    <p><strong>Unlimited</strong> Brandwidth</p>
                                </li>
                                <li><i class="far fa-browser mr-2"></i>
                                    <p><strong>1</strong> Websites Hosted</p>
                                </li>
                                ...
                                <li><i class="far fa-mail-bulk mr-2"></i>
                                    <p><strong>20</strong> Emails Accounts</p>
                                    <span class="text-under-line" data-toggle="tooltip" data-placement="top" title="" data-original-title="Create an unlimited number of mailboxes at no extra cost."><i class="fad fa-info-circle ml-1"></i></span>
                                </li>
                ...
                <div class="col-lg-4 col-md-6 col-sm-8">
                    <div class="popular-price bg-white pricing-new-wrapper mt-4 p-5 shadow-sm border">
                        <div class="pricing-price d-flex justify-content-between align-items-center pb-4">
                            <span class="p-icon"><i class="fad fa-rocket color-secondary"></i></span>
							<div>
							<div class="h2 mb-0 text-dark">$31.75<span class="price-cycle h5">/month</span></div>
                            <div class="h2 mb-0 text-dark">৳2699<span class="price-cycle h5">/month</span></div>
							</div>
                        </div>
                        <div class="pricing-info">
                            <h5>ECM PACK6</h5>
                        ...
                        <div class="pricing-content">
                            <ul class="list-unstyled pricing-feature-list-2 mt-4">
                                <li><i class="far fa-hdd mr-2"></i>
                                    <p><strong>20 GB</strong> SSD Disk Space</p>
                                    <span class="text-under-line" data-toggle="tooltip" data-placement="top" title="" data-original-title="SSD based cloud storage for awesome performance and reliability for your website."><i class="fad fa-info-circle ml-1"></i></span>
                                </li>
                                <li><i class="far fa-mail-bulk mr-2"></i>
                                    <p><strong>Unlimited</strong> Brandwidth</p>

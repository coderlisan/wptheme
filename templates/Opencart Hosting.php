...
/** Template Name: Opencart Hosting */
    ...
    <div class="container">
      <div class="row align-items-center justify-content-lg-between justify-content-md-center justify-content-sm-center">
        ...
        <div class="col-md-6 col-sm-12 col-lg-6">
          <div class="img-wrap"><img src="<?= get_template_directory_uri() ?>/assets/imgs/hero-img-new.svg" alt="hosting" class="img-fluid" /></div>
        </div>
      </div>
      <!--end of row-->
    </div>
    ...
    <div class="container">
      ...
      <div class="row align-items-center justify-content-md-center justify-content-center">
		  <div class="col-md-12 col-lg-12">
			  <h3 style="text-align:center;margin:100px">Coming Soon.... Surprise is coming... In Sa Allah</h3>
		  </div>
      </div>
    </div>
  </section>

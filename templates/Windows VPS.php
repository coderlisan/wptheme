      ...
      <div class="d-none">
        <div class="col-md-9 col-lg-8">
          <div class="section-heading text-center mb-5">
            ...
            <p class="lead">
              Our VPS Sevice Is Best Location In The World. 2x, 4x, 10x, 20x Speed For Diffirant Package..Total RDP Solution For Our Clinets..You Can Manage Remotly From Remote Desktop Computer...
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="row align-items-center justify-content-between">
        <div class="col-md-7 col-lg-6">
          <div class="feature-content-wrap">
            <h2>Best Widows VPS Service In Available Here</h2>
            <p>
              Windows VPS Hosting, Virtual Server
Hosting with Windows SystemsWith SSD driver and Instant Scalability, our Windows VPS Server in a dedicated environment is a good choice for hosting your websites and e-commerce model. Windows 2022 / 2019 / 2016 / 10/windows server 8,7 pro are available.
            </p>
      ...
      <div class="row align-items-center justify-content-between mt-5">
        ...
        <div class="col-md-7 col-lg-6">
          <div class="feature-content-wrap">
            ...
            <p>
              Fast Awarded Windows VPS Provider in Bangladesh
            </p>
            <a href="#" class="btn btn-outline-brand-01 mt-3" target="_blank">Learn More</a>
          </div>
        </div>
        ...
        <div class="col-md-9 col-lg-8">
          <div class="section-heading text-center mb-4">
            ...
            <p class="lead">
              ...
              principle-centered core competencies through client-centered core competencies.
            </p>
          </div>
        </div>
      </div>
          ...
          <div class="popular-price bg-white pricing-new-wrapper mt-4 p-5 shadow-sm border">
            ...
            <div class="pricing-content">
              <ul class="list-unstyled pricing-feature-list-2 mt-4">
                <li>
                  <p>1 GB Storage Space</p>
                </li>
                <li>
                  <p>100 GB Bandwidth</p>
                </li>
                <li>
                  <p>Unlimited E-Mail ID</p>
                </li>
                <li>
                  <p>99.9% Uptime</p>
                </li>
          ...
          <div class="popular-price bg-white pricing-new-wrapper mt-4 p-5 shadow-sm border">
            <div class="pricing-price d-flex justify-content-between align-items-center pb-4">
              <div class="h2 mb-0 text-dark">
                $12.99 <span class="price-cycle h5">/mo</span>
              </div>
            </div>
            <div class="pricing-info">
              <h5>Starter</h5>
        ...
        <div class="col-12">
          <div class="support-cta text-center mt-5">
            <a href="pricing-comparision.html" target="_blank">
              <h5 class="mb-1">
                <span class="ti-loop color-primary mr-2"></span>Compare Hosting Plans
              </h5>
            </a>
          </div>
        </div>
